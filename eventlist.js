...
function second_movie_ajax(){
    return $.ajax({
        url: 'https://api.themoviedb.org/3/discover/movie?api_key=fc3c055dbae6de898caa4bae948ed685&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=2&primary_release_year=2017&event_date.gte=2017-9-10&event_date.lte=2017-10-10',
        method: 'GET',
        dataType: 'json',
...
function third_movie_ajax(){
    return $.ajax({
        url: 'https://api.themoviedb.org/3/discover/movie?api_key=fc3c055dbae6de898caa4bae948ed685&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=3&primary_release_year=2017&event_date.gte=2017-9-10&event_date.lte=2017-10-10',
        method: 'GET',
        dataType: 'json',
        success: function(data){
            var results = data.results ;
