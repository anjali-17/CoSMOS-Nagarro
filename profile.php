            ...
            <div class="col-sm-6 col-md-6 col-lg-6" align="left">
                <div class="thumbnail">
                    ...
                    if($row) {
                        ...
                        echo"
                        <p class='card-description'><strong> Firstname </strong>:  ".$row["fname"]."</p>
                        <p class='card-description'><strong> Lastname </strong> :  ".$row['lname']."</p>
                        <p class='card-description'><strong> Username </strong> :  ".$row['uname']."</p>
                        <p class='card-description'><strong> DOB </strong>      :  ".$row['dob']."</p>
                        <p class='card-description'><strong> EMAIL </strong>   :  ".$row['email_id']."</p>"; }
                        ?>
                    </div>
                </div>
            </div>
                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <form role="form" action="class.UpdatePassword.php" method="post" class="login-form">
                            <p class="card-description"> <input type="text" name="oldpass" placeholder="Current Password..." class="form-username form-control" id="form-username"></p>
                            <p class="card-description">  <input type="password" name="newpass" placeholder="New Password..." class="form-password form-control" id="form-password"></p>
                            <p class="card-description">  <input type="password" name="confirmpass" placeholder="Confirm Password..." class="form-password form-control" id="form-password"></p>
