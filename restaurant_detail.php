...
<html lang="en">
   ...
   <body>
      ...
      <section id="testimonial" style="background-color:#DAF7A6;">
         <div class="container">
            <div class="row">
               <div class=" col-lg-7 col-md-7 col-sm-6">
                  ...
                  <div class="heading">
                     ...
                     <p>See the customer reviews first of the restaurant you are planning to go.</p>
                  </div>
               </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12 col-md-12">
                  ...
                  <div class="heading">
                     <h2 class="wow fadeInLeftBig">Recommended Hotels</h2>
                  </div>
                  <div class="team_area">
                     <!-- BEGAIN TEAM SLIDER -->
            ...
            <div class="row">
               <div class="col-lg-12 col-md-12 col-sm-12">
                  ...
                  <div class="heading">
                     ...
                     <p>Reserve in advance for this restaurant to get rid of hassle ahead.</p>
                  </div>
               </div>
            </div>
            <div class="row">
                     ...
                     <div class="contact_form">
                        ...
                        <form>
                           ...
                           <div class="form-group">
                              ...
                              <input class="form-control" type="time" placeholder="Reservation Time..." id = "time">
                           </div>
                           <div class="form-group">
                              <label class="control-label">
                              Special Requirements
                              </label>
                              <textarea class="form-control" cols="30" rows="10"  id="requirements"></textarea>
                           </div>
                        </form>
                        <div id="shade"></div>
                        <div id="modal">
                        ...
                        <p>
                           <button id="start" class="btn btn-primary btn-lg">Reserve Table</button>
                        </p>
         ...
         $('#input_date').val(today);
          ...
          var number = document.getElementById('number');
            ...
            document.getElementById("start").addEventListener("click", function(){
                         ...
                         title.innerHTML = 'Restaurant Booking';
                        ...
                        s.innerHTML = '<form method="post" action="class.test.php"><input type="hidden" id="t1" name="t1" value = "' + payableF + '">'+ '<input type="hidden" id="t2" name="t2" value = "' +couponF+ '">'+ '<input type="hidden" id="t3" name="t3" value = "' +timeF + '">'+ '<input type="hidden" id="t4" name="t4" value = "' + addressF + '">'+'<input type="hidden" id="t5" name="t5" value = "' + numberF + '">'+ '<input type="hidden" id="t6" name="t6" value = "' + nameF + '">'+'<input type="hidden" id="t7" name="t7" value = "' + datePicker.value +'">'+ '<input type="hidden" id="t8" name="t8" value = "' +"Restaurant"+ '">'+'<div class="col-lg-4"><button type="submit" class="btn btn-success btn-lg" data-toggle="modal" data-target="#" id = "button_confirm">Confirm Booking</button></div></form>';
            ...
            document.getElementById("button_redeem").addEventListener("click",function(){
                    ...
                    function setCoupon(id){
                        ...
                        var s = document.getElementById('form_submit');
                        s.innerHTML = '<form method="post" action="class.test.php"><input type="hidden" id="t1" name="t1" value = "' + payableF + '">'+ '<input type="hidden" id="t2" name="t2" value = "' +couponF+ '">'+ '<input type="hidden" id="t3" name="t3" value = "' +timeF + '">'+ '<input type="hidden" id="t4" name="t4" value = "' + addressF + '">'+'<input type="hidden" id="t5" name="t5" value = "' + numberF + '">'+ '<input type="hidden" id="t6" name="t6" value = "' + nameF + '">'+'<input type="hidden" id="t7" name="t7" value = "' + "2017-12-12" +'">'+ '<input type="hidden" id="t8" name="t8" value = "' +"Restaurant"+ '">'+'<div class="col-lg-4"><button type="submit" class="btn btn-success btn-lg" data-toggle="modal" data-target="#" id = "button_confirm">Confirm Booking</button></div></form>';
                    }
